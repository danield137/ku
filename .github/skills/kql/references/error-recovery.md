...
```kql
// ❌ — .show is a management command but works fine via ku
.show tables | project TableName

// ✅ — management commands work with ku, but don't pipe query operators onto them
// Step 1: ku --query ".show tables" --adaptive-output tables.kdf
